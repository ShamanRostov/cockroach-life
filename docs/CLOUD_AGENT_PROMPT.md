...
8. После каждого логического блока: **commit + push** на feature-ветку и обнови PR (не пушь напрямую в `main`)
...
- Работай в отдельной ветке; прогресс только через GitHub (см. `docs/CLOUD_CONTINUITY.md`)
